...
export function OpcaoMenu({ nome, svg, rota, onClick, ...rest }: OpcaoMenuProps) {
...
export function OpcaoMenuComSubmenu({ nome, svg, children }: OpcaoMenuComSubmenuProps) {
  ...
  return (
    <div className="mb-1">
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${aberto ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
